  ...
  return new Promise((resolve, reject) => {
    ...
    chavy.get(url, (error, response, data) => {
      try {
        ...
        chavy.log(`❌ ${cookieName} getinfo - response: ${response}`)
        resolve()
      }
    })
  })
  ...
  return new Promise((resolve, reject) => {
    ...
    chavy.post(url, (error, response, data) => {
      try {
        ...
        chavy.log(`❌ ${cookieName} signapp - response: ${response}`)
        resolve()
      }
    })
  })
  ...
  return new Promise((resolve, reject) => {
    ...
    chavy.get(url, (error, response, data) => {
      try {
        ...
        chavy.log(`❌ ${cookieName} getlottery - response: ${response}`)
        resolve()
      }
    })
  })
    ...
    setTimeout(() => {
      ...
      chavy.get(url, (error, response, data) => {
        try {
          ...
          chavy.log(`❌ ${cookieName} lotteryapp - response: ${response}`)
          resolve()
        }
      })
    }, cnt * 5000)
  ...
  return new Promise((resolve, reject) => {
    ...
    chavy.post(url, (error, response, data) => {
      try {
        ...
        chavy.log(`❌ ${cookieName} browseapp - response: ${response}`)
        resolve()
      }
    })
  })
